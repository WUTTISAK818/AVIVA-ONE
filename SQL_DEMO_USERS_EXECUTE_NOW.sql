-- =====================================================
-- AVIVA ONE v6.36 - CREATE 11 DEMO USERS (EXECUTE NOW)
-- =====================================================
-- Instructions:
-- 1. Go to: https://supabase.com/dashboard/project/ipxeraxcbxxsjimzougk/sql/new
-- 2. Copy entire script below (from BEGIN to COMMIT)
-- 3. Paste into SQL editor
-- 4. Click "Run" button
-- 5. Wait for green checkmark
-- Expected: "Query executed successfully - Rows affected: 11"
-- =====================================================
...
-- 3. Project Manager - Construction Management
INSERT INTO public.profiles (id, email, full_name, role, department, phone, is_active, is_demo, created_at, updated_at)
...
-- 4. Sales Manager - Sales Management
INSERT INTO public.profiles (id, email, full_name, role, department, phone, is_active, is_demo, created_at, updated_at)
...
-- 8. QA Inspector - Quality Assurance
INSERT INTO public.profiles (id, email, full_name, role, department, phone, is_active, is_demo, created_at, updated_at)
...
-- =====================================================
-- VERIFICATION QUERIES (Run after COMMIT succeeds)
-- =====================================================

-- Verify: Count all demo users created
SELECT
...
-- Verify: List all demo users with details
SELECT
  email,
  full_name,
  role,
...
-- =====================================================
-- CLEANUP (Run ONLY after testing is complete)
-- =====================================================
--
-- To delete all demo users after testing:
--
