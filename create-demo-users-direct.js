...
if (!SERVICE_ROLE_KEY) {
  ...
  console.error('Usage: node create-demo-users-direct.js "your-service-role-key"');
  console.error('Or: export SUPABASE_SERVICE_ROLE_KEY="your-key" && node create-demo-users-direct.js');
  process.exit(1);
}
