...
## 🟡 แผนรอดำเนินการ (auto-pull รายงาน) — ลดงานซ้ำซ้อนรายงานประจำวัน

> 📌 หมายเหตุ: "Phase" = หมายเลขแชต/session (ไม่ใช่หมวดงาน) · Phase 4 = แชตที่ 4 · แผนด้านล่างนี้คือ "แผน auto-pull" เป็นหนึ่งในงานที่รอทำ ไม่ใช่ตัว Phase
