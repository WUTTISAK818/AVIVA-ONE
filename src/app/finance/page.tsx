          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-aviva-secondary mt-0.5">
                ...
                {pendingApprovals > 0 && (
                  <span className="ml-2 bg-red-500/20 text-red-400 px-1.5 py-0.5 rounded-full text-[10px]">
      ...
      <div className="px-4 py-5 max-w-lg mx-auto space-y-5">
        ...
        <div className="grid grid-cols-3 gap-3">
          <GlassCard className="p-3 text-center">
            ...
            <p className="text-base font-bold text-green-400">{formatM(totalIncome || mockSummary.totalIncome)}</p>
            <p className="text-[10px] text-aviva-secondary mt-0.5">รายรับรวม</p>
          </GlassCard>
          <GlassCard className="p-3 text-center">
            <TrendingDown size={16} className="text-red-400 mx-auto mb-1" />
            <p className="text-base font-bold text-red-400">{formatM(totalExpenses || mockSummary.totalExpenses)}</p>
          ...
          <GlassCard gold className="p-3 text-center">
            ...
            <p className="text-base font-bold text-aviva-gold">{formatM(netCashflow || 93_000_000)}</p>
          ...
          <div className="space-y-2">
            ...
            {loading ? [1,2,3].map(i => <div key={i} className="h-14 rounded-xl bg-aviva-card/50 animate-pulse" />) : (
              transactions.length === 0
                ? <GlassCard className="p-6 text-center"><p className="text-aviva-secondary text-sm">ยังไม่มีรายการ กดปุ่ม + เพื่อเพิ่ม</p></GlassCard>
                : transactions.map((tx) => (
