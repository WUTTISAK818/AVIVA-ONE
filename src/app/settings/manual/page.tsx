...
const sections: Section[] = [
  {
    ...
    topics: [
      ...
      { title: "ผู้ช่วย น้อง Viva (ปุ่มทุกหน้า) — ถาม & สั่งให้ช่วยทำ", steps: [
        ...
        "โหมดลงมือทำ (Action): สั่งสร้างคำขอซื้อแทนได้ เช่น 'ซื้อมือถือให้ฝ่ายขาย 1 เครื่อง' — ถ้ายังไม่บอกราคา Viva จะถามก่อน",
        "Viva จะสรุป 'การ์ดยืนยัน' (รายการ/ราคา/หมวด) ให้ตรวจก่อนเสมอ — กด 'ยืนยันสร้างคำขอ' จึงจะสร้างจริง",
        "เมื่อยืนยัน Viva สร้างคำขอ PR-xxxx + ส่งเข้าสายอนุมัติให้อัตโนมัติ (≥ ฿2,000 ต้องผ่านผู้บริหาร · ต่ำกว่านั้นอนุมัติอัตโนมัติ)",
        "Viva ทำได้แค่ 'เปิดคำขอ' แทน — ขั้นอนุมัติและจ่ายเงินยังเป็นผู้บริหาร/การเงินตามอำนาจ (ระบบ Maker-Checker)",
      ]},
