...
const sections: Section[] = [
    ...
    topics: [
      {
        title: "ภาพรวมโครงการ",
        steps: [
          "กดการ์ด 'ยูนิตทั้งหมด / ขายแล้ว / ว่างอยู่' เพื่อดูรายละเอียด",
          "ดูกราฟรายรับ-รายจ่ายรายเดือน",
          "AI Executive Insights วิเคราะห์สถานะโครงการ real-time",
        ],
      },
      {
        title: "AVIVA AI Executive",
        steps: [
          "กดกล่อง 'AVIVA AI Executive' ที่ด้านบนสุดเพื่อเปิดแชท",
          "พิมพ์คำถามเกี่ยวกับข้อมูลโครงการ เช่น 'ยอดขายเดือนนี้เท่าไร'",
          "AI จะดึงข้อมูลจากฐานข้อมูลจริงและตอบทันที",
        ],
      },
      {
        title: "ปฏิทินกิจกรรม",
        steps: [
          "เลื่อนลงไปด้านล่างสุดของหน้าหลัก",
          "กดวันที่เพื่อเพิ่ม / ดูกิจกรรม",
          "ทำเครื่องหมาย Done ✓ เมื่อกิจกรรมเสร็จ",
        ],
      },
    ],
  },
    ...
    topics: [
      {
        ...
        steps: [
          "กดปุ่ม '+' หรือ 'เพิ่ม Lead' ในแท็บ Leads",
          "กรอกชื่อ เบอร์โทร งบประมาณ และสถานะ",
          "กด 'บันทึก' — ระบบจะสร้างโปรไฟล์ลูกค้าใหม่",
        ],
      },
      {
        ...
        steps: [
          ...
          "เลือกสถานะใหม่: New → Contacted → Interested → Site Visit → Booking → Closed Deal",
          "เมื่อสถานะเป็น 'Booking' ระบบจะให้ระบุแปลงที่จอง",
          "AI Score คำนวณอัตโนมัติจากสถานะและความเร่งด่วน",
        ],
      },
      {
        title: "แผนผังโครงการ",
        steps: [
          "กดแท็บ 'แผนผัง' เพื่อดูแปลงทั้ง 31 แปลง",
          "สีทอง = จอง/ขายแล้ว, สีขาว = ว่าง",
          "กดแปลงเพื่อดูรายละเอียดและลูกค้า (ถ้ามี)",
        ],
      },
      {
        title: "พิมพ์เอกสาร",
        steps: [
          "กดลูกค้าที่สถานะ Booking ขึ้นไป",
          "เลือก 'พิมพ์ใบเสนอราคา' หรือ 'พิมพ์ใบจอง'",
          "เอกสารจะเปิดในหน้าใหม่พร้อมพิมพ์",
        ],
      },
      {
    ...
    topics: [
      {
        title: "ตรวจงวดงาน",
        steps: [
          "กดยูนิตที่ต้องการตรวจในรายการ",
          "กด 'ตรวจงวดงาน' เพื่อดู Checklist 10 งวด",
          "ทำเครื่องหมาย ✓ ผ่าน หรือ ✗ ไม่ผ่าน พร้อมหมายเหตุ",
          "แนบรูปถ่ายหน้างาน (กดปุ่มกล้อง)",
        ],
      },
      {
        title: "ส่งเบิกงวดงาน",
        steps: [
          "หลังตรวจผ่านครบ — กดปุ่ม 'ส่งเบิก'",
          "ระบบจะสร้างเลขที่ INST-YYYY-XXX อัตโนมัติ",
          "แจ้งเตือนผู้จัดการให้อนุมัติ",
        ],
      },
      {
        title: "รายงานรายวัน",
        steps: [
          ...
          "กรอกงานที่ทำ ความคืบหน้า และปัญหาที่พบ",
          "กด 'พิมพ์รายงาน' เพื่อพิมพ์ PDF",
        ],
      },
      {
        title: "จัดซื้อวัสดุ (PO)",
        steps: [
          "กดปุ่ม 'ยื่น PO' ในหน้าก่อสร้าง",
          "กรอกรายการวัสดุ จำนวน ราคา และผู้ขาย",
          "ส่งขออนุมัติ — ผู้จัดการจะเห็นใน 'คำขออนุมัติ'",
        ],
      },
    ],
  },
    ...
    topics: [
      {
        title: "บริหารเอกสาร",
        steps: [
          "ไปแท็บ 'เอกสาร' ในหน้าออฟฟิศ",
          "กด 'เพิ่มเอกสาร' — กรอกชื่อ หมวด และรายละเอียด",
          "ระบบสร้างเลขที่ DOC-YYYY-XXX อัตโนมัติ",
        ],
      },
      {
        title: "จัดการพนักงาน",
        steps: [
          "ไปแท็บ 'บุคคล' → 'พนักงาน'",
          "เพิ่ม/แก้ไขข้อมูลพนักงาน ตำแหน่ง แผนก เงินเดือน",
          "กด 'ออก Payslip' เพื่อพิมพ์สลิปเงินเดือน",
        ],
      },
      {
        ...
        steps: [
          ...
          "กรอกจำนวนเงิน รายละเอียด และวันที่",
        ],
      },
      {
        title: "ขออนุมัติรายจ่าย (FIN)",
        steps: [
          "ไปแท็บ 'อนุมัติ' → กด 'ยื่นขออนุมัติ'",
          "กรอกวงเงินและเหตุผล",
          "ระบบสร้างเลขที่ FIN-YYYY-XXX และส่งแจ้งเตือนผู้จัดการ",
        ],
      },
    ],
  },
    ...
    topics: [
      {
        title: "รับแจ้งซ่อม",
        steps: [
          "ไปหน้า 'ออฟฟิศ' → แท็บ 'หลังการขาย'",
          "กดปุ่ม 'แจ้งซ่อม' — กรอกชื่อลูกค้า แปลงบ้าน ประเภทปัญหา",
          "มอบหมายช่าง และระบุวันนัดซ่อม",
          "ระบบสร้างเลขที่ WR-YYYY-XXX อัตโนมัติ",
        ],
      },
      {
        title: "อัปเดตสถานะเคส",
        steps: [
          "กดเคสที่ต้องการอัปเดต",
      ...
      },
      {
        ...
        steps: [
          ...
          "ดูรายละเอียดเคสในแต่ละสถานะ",
          "คะแนน Satisfaction เฉลี่ยแสดงที่การ์ด 'เสร็จสิ้น'",
        ],
      },
    ],
  },
  {
    ...
    topics: [
      {
        title: "ดูรายการรออนุมัติ",
        steps: [
          "กดไอคอน ✓ (BadgeCheck) มุมบนขวาของหน้าหลัก",
          "หรือไปที่ /approvals โดยตรง",
          "รายการแบ่งตามประเภท: งวดงาน / PO / FIN / เอกสาร / ลา",
        ],
      },
      {
        title: "อนุมัติ / ปฏิเสธ",
        steps: [
          "กดรายการที่ต้องการดำเนินการ",
          "กด 'อนุมัติ' เพื่อดำเนินการต่อ หรือ 'ปฏิเสธ' พร้อมระบุเหตุผล",
          "ระบบอัปเดตสถานะในหน้าที่เกี่ยวข้องทันที",
        ],
      },
    ],
  },
      ...
      <div className="px-4 py-6 max-w-lg mx-auto space-y-3">
        <GlassCard className="p-4">
          <p className="text-xs text-aviva-secondary">
            คู่มือการใช้งาน AVIVA ONE สำหรับผู้ปฏิบัติงานทุกฝ่าย กดหัวข้อเพื่อดูรายละเอียด
          </p>
        </GlassCard>
