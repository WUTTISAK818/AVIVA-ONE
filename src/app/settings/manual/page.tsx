...
const sections: Section[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { title: "ข้อควรระวังในระบบ (2 ชุดยังไม่เชื่อมกัน)", steps: [
        "ชุด A (อัตโนมัติ): เงินสดย่อย/PR/จ่ายงวด → ลง JV เอง",
        "ชุด B (กรอกมือ): ลูกหนี้ AR / เจ้าหนี้ AP / ทะเบียนภาษีซื้อ-ขาย (office → แท็บบัญชี)",
        "รายการชุด A ไม่ไหลเข้าทะเบียนภาษีชุด B อัตโนมัติ → บัญชีต้องกรอกทะเบียนภาษีซ้ำ กัน VAT ตกหล่น",
        "อยู่ระหว่างพัฒนาให้เชื่อมกันในรอบถัดไป",
      ]},
    ],
  },
];
