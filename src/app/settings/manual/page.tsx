...
const sections: Section[] = [
  {
    ...
    topics: [
      ...
      { title: "ผู้ช่วย น้อง Viva (ปุ่มทุกหน้า)", steps: [
        "ปุ่มสีทอง 'น้อง Viva' ลอยมุมขวาล่าง มีอยู่ทุกหน้า — กดเพื่อถามวิธีทำงานในแอป",
        "ถามได้ทุกเรื่องทุกฝ่าย เช่น 'ลงค่าอาหารดูแลลูกค้าทำยังไง', 'อยากขอซื้อมือถือเริ่มที่ไหน', 'เบิกงวดงานผู้รับเหมาทำยังไง'",
        "AI ตอบเป็นขั้นตอนทำตามได้ทันที ระบุเมนู/ปุ่มจริง อ้างอิงกระบวนการของบริษัท",
        "มีคำถามตัวอย่างให้กดเลือกได้ตอนเปิดครั้งแรก",
      ]},
