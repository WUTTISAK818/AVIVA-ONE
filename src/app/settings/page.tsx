...
import { Moon, Sun, Monitor, Settings, Users, Building2, ChevronRight, User, Save, Check, BookOpen, FileText, GitBranch, ClipboardList, HardHat } from "lucide-react";
    ...
    <div className="min-h-screen bg-aviva-bg pb-24">
      ...
      <div className="px-4 py-6 max-w-lg mx-auto space-y-5">
        ...
        <div className="pt-2 pb-4 text-center space-y-1">
          ...
          <p className="text-[11px] text-aviva-secondary/60">Version 4.67</p>
