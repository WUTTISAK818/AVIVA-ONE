...
import {
  ...
  Megaphone, UserCheck, Package, Receipt,
} from "lucide-react";
...
export default function BottomNav() {
  ...
  const residentTabs = [
    { href: "/community/announcements", label: "ประกาศ",     icon: Megaphone, show: true },
    { href: "/community/visitors",      label: "ผู้มาเยือน", icon: UserCheck, show: true },
    { href: "/community/parcels",       label: "พัสดุ",      icon: Package,   show: true },
    { href: "/community/bills",         label: "บิล",        icon: Receipt,   show: true },
